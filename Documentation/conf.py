...
htmlhelp_basename = 'TYPO3JobRouterProcessdoc'
...
latex_documents = [
    (master_doc, 'TYPO3JobRouterProcess.tex', u'TYPO3 JobRouter Process Documentation',
...
man_pages = [
    (master_doc, 'typo3jobrouterprocess', u'TYPO3 JobRouter Process Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'TYPO3JobRouterProcess', u'TYPO3 JobRouter Process Documentation',
     author, 'TYPO3JobRouterProcess', 'One line description of project.',
     'Miscellaneous'),
]
